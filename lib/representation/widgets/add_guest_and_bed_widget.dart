...
class AddGuestAndRoom extends StatefulWidget {
  const AddGuestAndRoom(
      {super.key,
      required this.title,
      required this.icon,
  ...
  @override
  State<AddGuestAndRoom> createState() => _AddGuestAndRoomState();
}

class _AddGuestAndRoomState extends State<AddGuestAndRoom> {
